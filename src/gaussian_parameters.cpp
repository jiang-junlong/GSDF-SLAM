...
GaussianPipelineParams::GaussianPipelineParams(bool convert_SHs, bool compute_cov3D, bool separate_sh)
    : convert_SHs_(convert_SHs), compute_cov3D_(compute_cov3D), separate_sh_(separate_sh)
{}
